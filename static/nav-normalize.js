(() => {
  ...
  const isActive = (key) => {
    ...
    if (key === 'learning') return path === '/learning-intelligence' || path === '/learning-profile' || path === '/review-schedule';
