...
| UM-05 | Duplicate Question Review | Fully automatable | Captured | [UM-05-duplicate-question-review.png](images/UM-05-duplicate-question-review.png) | Advisory matches with quiz/folder/search filters and page-scoped expand/collapse controls. |
