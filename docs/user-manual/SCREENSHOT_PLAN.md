...
| UM-05 | 5. Duplicate review | Duplicate Question Review with an expanded exact-match group and result controls | Quiz/folder/search filters; page-scoped expand/collapse; source quiz/question context; advisory-only nature; Edit source link | Purpose-written synthetic questions; no copied material; the current deterministic fixture has no possible matches | Focused content area; Light | None | Useful for a non-obvious workflow; low-to-moderate staleness |
