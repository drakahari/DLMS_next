...
class ReleaseDocumentationTests(unittest.TestCase):
    ...
    def test_current_release_text_has_no_prerelease_label(self):
        ...
        self.assertEqual(server_template_source.count("DLMS v{{ app_version }}"), 11)
        self.assertEqual(
    ...
    def test_checksum_helper_rejects_noncanonical_or_incomplete_final_set(self):
        ...
        with tempfile.TemporaryDirectory(prefix="dlms-checksums-") as directory:
            root = Path(directory)
            artifacts = [root / "DLMS-3.2.0-RC4-windows-x86_64.zip"]
    ...
    def test_native_artifact_verification_is_a_documented_release_gate(self):
        ...
        self.assertNotIn("DLMS-3.2.1-linux-x86_64", readme + procedure)
        self.assertNotIn("DLMS-3.2.1-windows-x86_64.exe", readme + procedure)
    ...
    def test_final_release_packages_and_authoritative_documents_are_documented(self):
        ...
        self.assertIn("Do not\ncreate or upload `DLMS-3.2.1-source.zip`", procedure)
        self.assertNotRegex(
    ...
    def test_macos_release_is_a_native_app_zip_with_first_run_guidance(self):
        ...
        macos_zip = "DLMS-3.2.1-macos-arm64.zip"
        ...
        self.assertNotIn("* macOS: `DLMS-3.2.1-macos-arm64`", readme)
    ...
    def test_macos_bundle_version_fields_follow_current_release_metadata(self):
        ...
        self.assertEqual(metadata["app_release_version"], "3.2.1")
        self.assertEqual(metadata["app_bundle_version"], "3.2.1")
        self.assertEqual(metadata["app_bundle_build_version"], "3.2.1")
