...
class PDFImportBlueprintTests(unittest.TestCase):
    EXPECTED_RULES = {
        ...
        "pdf_import.pdf_import_ocr_region_preview": ("/pdf-import/ocr/<draft_id>/region/<source_id>", {"GET"}),
    ...
    EXPECTED_DEPENDENCIES = {
        ...
        "find_pdf_targeted_ocr_candidates",
        "stage_pdf_ocr_document",
        "validate_pdf_ocr_selection",
        "render_pdf_ocr_page",
        "render_pdf_ocr_region",
        "recognize_pdf_ocr_page",
        "parse_pdf_raster_choices",
        "merge_pdf_raster_choices",
        "pdf_ocr_page_preview_path",
        "pdf_ocr_region_preview_path",
    ...
    def test_namespaced_endpoints_build_original_public_urls(self):
        values = {
            ...
            "pdf_import.pdf_import_ocr_region_preview": {"draft_id": "draft", "source_id": "source"},
