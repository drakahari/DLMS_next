...
- Fedora 44: DLMS-3.2.1-fedora44-x86_64.tar.gz
- Ubuntu 24.04: DLMS-3.2.1-ubuntu24.04-x86_64.tar.gz
- Ubuntu 26.04: DLMS-3.2.1-ubuntu26.04-x86_64.tar.gz
- Windows 11: DLMS-3.2.1-windows11-x86_64.zip
- macOS Apple Silicon: DLMS-3.2.1-macos-arm64.zip
- Omarchy Quattro: DLMS-3.2.1-omarchy-quattro-x86_64.tar.gz
...
method removed it, restore it with:
   ...
   chmod +x DLMS-3.2.1-<platform>-x86_64
...
DLMS 3.2.1 is not notarized, so macOS may require approval in System Settings >
