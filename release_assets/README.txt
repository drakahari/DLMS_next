...
- Fedora 44: DLMS-3.2.2-fedora44-x86_64.tar.gz
- Ubuntu 24.04: DLMS-3.2.2-ubuntu24.04-x86_64.tar.gz
- Ubuntu 26.04: DLMS-3.2.2-ubuntu26.04-x86_64.tar.gz
- Windows 11: DLMS-3.2.2-windows11-x86_64.zip
- macOS Apple Silicon: DLMS-3.2.2-macos-arm64.zip
- Omarchy Quattro: DLMS-3.2.2-omarchy-quattro-x86_64.tar.gz
...
method removed it, restore it with:
   ...
   chmod +x DLMS-3.2.2-<platform>-x86_64
...
DLMS 3.2.2 is not notarized, so macOS may require approval in System Settings >
